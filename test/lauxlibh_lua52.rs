...
pub extern "C" {
    ...
    fn lua_tolstring(+L: *lua_State, +idx: c_int, +len: *size_t) -> *c_schar;
    ...
    fn lua_pushlstring(+L: *lua_State, +s: *c_schar, +l: size_t) -> *c_schar;
    fn lua_pushstring(+L: *lua_State, +s: *c_schar) -> *c_schar;
//    fn lua_pushvfstring(+L: *lua_State, +fmt: *c_schar, +argp: *__va_list_tag)
//     -> *c_schar;
    ...
    fn lua_callk(+L: *lua_State, +nargs: c_int, +nresults: c_int, +ctx: c_int,
                 +k: lua_CFunction);
    ...
    fn lua_dump(+L: *lua_State, +writer: lua_Writer, +data: *c_void) -> c_int;
    fn lua_yieldk(+L: *lua_State, +nresults: c_int, +ctx: c_int,
                  +k: lua_CFunction) -> c_int;
    fn lua_resume(+L: *lua_State, +from: *lua_State, +narg: c_int) -> c_int;
...
//    fn lua_getstack(+L: *lua_State, +level: c_int, +ar: *lua_Debug) -> c_int;
//    fn lua_getinfo(+L: *lua_State, +what: *c_schar, +ar: *lua_Debug) -> c_int;
//    fn lua_getlocal(+L: *lua_State, +ar: *lua_Debug, +n: c_int) -> *c_schar;
//    fn lua_setlocal(+L: *lua_State, +ar: *lua_Debug, +n: c_int) -> *c_schar;
    ...
    fn luaL_getmetafield(+L: *lua_State, +obj: c_int, +e: *c_schar) -> c_int;
    fn luaL_callmeta(+L: *lua_State, +obj: c_int, +e: *c_schar) -> c_int;
    fn luaL_tolstring(+L: *lua_State, +idx: c_int, +len: *size_t) -> *c_schar;
