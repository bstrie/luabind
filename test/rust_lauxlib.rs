...
//type lua_Debug = Struct_lua_Debug;
type lua_Hook = *u8;
...
//}
struct Struct_luaL_Reg {
    name: *c_schar,
    func: lua_CFunction,
}
type luaL_Reg = Struct_luaL_Reg;
struct Struct_luaL_Buffer {
    b: *c_schar,
    size: size_t,
    n: size_t,
    L: *lua_State,
...
type luaL_Buffer = Struct_luaL_Buffer;
struct Struct_luaL_Stream {
    f: *FILE,
    closef: lua_CFunction,
}
type luaL_Stream = Struct_luaL_Stream;
#[link_args = "-llua"]
extern {
