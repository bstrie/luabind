...
//    fn lua_setlevel(from: *mut lua_State, to: *mut lua_State);
    ...
    fn luaL_openlib(L: *mut lua_State, libname: *c_schar, l: *luaL_Reg,
                    nup: c_int);
    fn luaL_register(L: *mut lua_State, libname: *c_schar, l: *luaL_Reg);
    fn luaL_getmetafield(L: *mut lua_State, obj: c_int, e: *c_schar) -> c_int;
    fn luaL_callmeta(L: *mut lua_State, obj: c_int, e: *c_schar) -> c_int;
    fn luaL_typerror(L: *mut lua_State, narg: c_int, tname: *c_schar) ->
     c_int;
    ...
    fn luaL_loadfile(L: *mut lua_State, filename: *c_schar) -> c_int;
    fn luaL_loadbuffer(L: *mut lua_State, buff: *c_schar, sz: size_t,
                       name: *c_schar) -> c_int;
    fn luaL_loadstring(L: *mut lua_State, s: *c_schar) -> c_int;
    fn luaL_newstate() -> *mut lua_State;
    fn luaL_gsub(L: *mut lua_State, s: *c_schar, p: *c_schar, r: *c_schar) ->
     *c_schar;
    fn luaL_findtable(L: *mut lua_State, idx: c_int, fname: *c_schar,
                      szhint: c_int) -> *c_schar;
    ...
    fn luaL_prepbuffer(B: *mut luaL_Buffer) -> *mut c_schar;
